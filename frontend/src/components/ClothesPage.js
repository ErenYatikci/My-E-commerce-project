...
const ClothesPage = () => {
    ...
    const fetchData = async () => {
        let route = 'https://localhost:8443/api/v1/products/category?category=clothes';

        if(pref==="2"){
            route = 'https://localhost:8443/api/v1/products/specific?sex=male&category=clothes'
        }else if(pref==="3"){
            route = 'https://localhost:8443/api/v1/products/specific?sex=female&category=clothes'
        }
    ...
    return (
        <div className="jumbotron">
            <h1 className="display-4">Clothes Store</h1>
            <Row>
                <Col span={18}>
