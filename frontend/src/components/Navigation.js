...
const Navigation = () => {
    ...
    return (
        <div className="navbar navbar-expand-lg fixed-top navbar-light bg-light shadow-4" style={{ fontFamily: "'Open Sans Condensed', sans-serif", fontSize: "25px", }}>
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
                <span className="navbar-toggler-icon"></span>
            </button>
            <Link style={{ textDecoration: 'none' }} to='/' ><p className=" ffff nav-link pa2 f3 black" >Home</p></Link>

            <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li className="nav-item active">
                        <Link style={{ textDecoration: 'wavy' }} to='/store' > <p className="nav-link dim">Store<span className="sr-only">(current)</span> </p></Link>
                    </li>
                    <li className="nav-item">
                        <Link style={{ textDecoration: 'none' }} to='/clothes' > <p className="nav-link">Clothes</p></Link>
                    </li>
                    <li className="nav-item">
                        <Link style={{ textDecoration: 'none' }} to='/accesories' > <p className="nav-link">Accesories</p></Link>
                    </li>
                    <li className="nav-item">
                ...
                <div className="form-inline my-2 my-lg-0 pa0">
                    <input className="form-control mr-sm-2" type="search" placeholder="Search Products" aria-label="Search" onChange={e => setSearch(e.target.value)} />
                    ...
                    <Link style={{ textDecoration:"none", position: "relative", textAlign: "center" }} to="/checkout">
                        ...
                        <h4 style={{ position: "absolute", top: "-15px", left: "40px" }}>{getValue()}</h4>
                    </Link>
                </div>
            </div>
        </div>
