...
const DiscounterStorePage = () => {
    ...
    const fetchData = async () => {
        let route = 'https://localhost:8443/api/v1/products/category?category=accesories';

        if(pref==="2"){
            route = 'https://localhost:8443/api/v1/products/specific?sex=male&category=accesories'
        }else if(pref==="3"){
            route = 'https://localhost:8443/api/v1/products/specific?sex=female&category=accesories'
        }
    ...
    return (
        <div className="jumbotron">
            <h1 className="display-4">Accesories Store</h1>
            <Row>
                <Col span={18}>
